...
//import imgs
import shopImg from "../imgs/Rectangle 3705(1).png";
const AsideAbout = () => {
  ...
  const [count4, setCount4]= useState(0);
   ...
   let incNum1 =()=>{
    ...
    <button className='btnFrame2'> الدفع</button>
    <button className='btnFrame'>تحديث السلة </button>
    </div>
